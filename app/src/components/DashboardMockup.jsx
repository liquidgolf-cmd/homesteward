      ...
      <div className="p-5">
        ...
        <div className={`grid gap-2 mb-4 grid-cols-3`}>
          <div className={`rounded-xl bg-navy-light border border-[var(--border-soft)] ${compact ? 'p-2' : 'p-4'}`}>
            ...
            <div className={`font-heading text-yellow mt-0.5 ${compact ? 'text-xl' : 'text-3xl'}`}>187</div>
          ...
          <div className={`rounded-xl bg-navy-light border border-[var(--border-soft)] ${compact ? 'p-2' : 'p-4'}`}>
            ...
            <div className={`font-heading text-yellow mt-0.5 ${compact ? 'text-xl' : 'text-3xl'}`}>3</div>
          ...
          <div className={`rounded-xl bg-navy-light border border-[var(--border-soft)] ${compact ? 'p-2' : 'p-4'}`}>
            ...
            <div className={`font-heading text-yellow mt-0.5 ${compact ? 'text-xl' : 'text-3xl'}`}>7</div>
        ...
        <div className="rounded-xl bg-navy-light border border-[var(--border-soft)] p-4 mb-4">
          ...
          <div className="text-2xl font-medium text-yellow">$22.4M</div>
          <div className="text-[11px] text-slate">187 households</div>
          <div className="text-[11px] text-yellow mt-0.5">↑ 11.2% this year</div>
        </div>
        ...
        <div className="rounded-xl bg-navy-light border border-[var(--border-soft)] p-3">
          ...
          {[
            ...
            <div key={row.initials} className="flex items-center gap-2 py-2.5 border-b border-white/5 last:border-0">
              <div className="w-8 h-8 rounded-full bg-[var(--gold-glow)] flex items-center justify-center text-[10px] text-yellow font-medium shrink-0">
                {row.initials}
              </div>
              ...
              <span className={`text-[9px] px-2 py-0.5 rounded border shrink-0 ${
                row.tagColor === 'green' ? 'bg-green/10 text-green border-green/20' : 'bg-[var(--gold-glow)] text-yellow border-[rgba(201,168,76,0.3)]'
              }`}>
                {row.tag}
              </span>
              <span className="text-[9px] px-2 py-1 rounded bg-yellow text-navy border border-yellow shrink-0 font-medium">Review</span>
            </div>
          ))}
        </div>
      </div>
